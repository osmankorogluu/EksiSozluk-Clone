...
using EksiSozlukClone.Common.Infrastructure;
...
namespace EksiSozlukClone.Infrastructure.Persistence.Context
{
    ...
    internal class SeedData
    {
        ...
        public async Task SeedAsync(IConfiguration configuration)
        {
            ...
            dbContextBuilder.UseSqlServer(configuration["BloggingDatabase"]);
            ...
            var entries = new Faker<EksiSozlukClone.Api.Domain.Models.Entry >("tr")
            ...
            var comments = new Faker<EksiSozlukClone.Api.Domain.Models.EntryComment> ("tr")
                    .RuleFor(i => i.Id, i => Guid.NewGuid())
                    .RuleFor(i => i.CreateDate,
                                i => i.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now))
                    .RuleFor(i => i.Content, i => i.Lorem.Paragraph(2))
